...
import { Loader2, ArrowLeft, Video, Gift, Users } from "lucide-react";
...
export default function ProfilePage() {
        ...
        const fetchAll = async () => {
            try {
                ...
                const [profileRes, streamsRes, giftsRes] = await Promise.all([
                    ...
                    api
                        .get(`/live`, { params: { userId: targetUserId } })
                        .catch(() => ({ data: [] })),
                ...
                setStreams(
                    streamsRes.data?.streams || streamsRes.data || []
                );
                setReceivedGifts(
                    giftsRes.data?.gifts || giftsRes.data || []
                );
            } catch (err) {
    ...
    const stats = {
        ...
        coins: profile?.wallet?.balance ?? 0,
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white">
            <div className="max-w-4xl mx-auto px-4 py-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-3 text-center">
                        <p className="text-xs text-white/50 mb-1">Coins</p>
