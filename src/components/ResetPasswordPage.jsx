            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-blue-900 to-black px-4">
                <div className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl text-center">
                    ...
                    <div className="w-full bg-white/10 rounded-full h-1 mb-6 overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-cyan-500 to-blue-500 animate-progress"
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                placeholder="••••••••"
                                className={`w-full pl-12 pr-12 py-3 bg-white/10 border rounded-xl text-white placeholder-white/40 focus:outline-none transition ${formData.confirmPassword && formData.newPassword !== formData.confirmPassword
                    ...
                    <div className="p-3 bg-white/5 rounded-xl border border-white/10">
                        ...
                        <ul className="text-xs space-y-1">
                            <li className={formData.newPassword.length >= 6 ? "text-green-400" : "text-white/40"}>
                                {formData.newPassword.length >= 6 ? "✓" : "○"} At least 6 characters
                            </li>
                            <li className={/[A-Z]/.test(formData.newPassword) ? "text-green-400" : "text-white/40"}>
                                {/[A-Z]/.test(formData.newPassword) ? "✓" : "○"} One uppercase letter
                            </li>
                            <li className={/[0-9]/.test(formData.newPassword) ? "text-green-400" : "text-white/40"}>
